...
# save in csv
thetashoulderabd.to_csv("python_dl009_shouabdoutput_001sho.csv", header=False)
...
plt.savefig('/workspaces/JointAngleEstimation/Matlab/Plot_vicon_angle_vs_frames/Shoulder_Abduction.png')
plt.show()
...
plt.legend(labels = ['Vicon'])
plt.savefig('/workspaces/JointAngleEstimation/Matlab/Plot_vicon_angle_vs_frames/Elbow_Flexion.png')
plt.show()
...
plt.legend(labels = ['Vicon'])
plt.savefig('/workspaces/JointAngleEstimation/Matlab/Plot_vicon_angle_vs_frames/Shoulder_Extension.png')
plt.show()
...
plt.legend(labels = ['Vicon'])
plt.savefig('/workspaces/JointAngleEstimation/Matlab/Plot_vicon_angle_vs_frames/Shoulder_Flexion.png')
plt.show()
