...
def joint_angle(joint, _keypoints_and_edges_for_display):
    ...
    try:
        if joint in "left_elbow":
            a = np.array(
                [keypoint_locs[5, 1], keypoint_locs[5, 0]]
            )  #'left_shoulder': 5,
            ...
            a = np.array(
                [keypoint_locs[6, 1], keypoint_locs[6, 0]]
            )  #'right_shoulder': 6,
            b = np.array([keypoint_locs[8, 1], keypoint_locs[8, 0]])  #'right_elbow': 8,
            c = np.array(
                [keypoint_locs[10, 1], keypoint_locs[10, 0]]
            )  #'right_wrist': 10,
            ...
            c = np.array(
                [keypoint_locs[13, 1], keypoint_locs[13, 0]]
            )  #'left_knee': 13,
            ...
            c = np.array(
                [keypoint_locs[15, 1], keypoint_locs[15, 0]]
            )  #'left_ankle': 15,
            ...
            c = np.array(
                [keypoint_locs[12, 1], keypoint_locs[12, 0]]
            )  #'right_hip': 12,
            ...
            c = np.array(
                [keypoint_locs[14, 1], keypoint_locs[14, 0]]
            )  #'right_knee': 14,
            ...
            c = np.array(
                [keypoint_locs[16, 1], keypoint_locs[16, 0]]
            )  #'right_ankle': 16,
